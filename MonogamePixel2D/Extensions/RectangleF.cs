...
namespace ShotgunGame.Extended
{
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        /// <summary>
        ///     Gets the <see cref="Vector2"/> representing the extents of this <see cref="RectangleF" />.
        /// </summary>
        public Vector2 Size
        {
        ...
        public bool Intersects(Line line)
        {
            Span<Line> edges =
            [
                new Line(Left, Top, Left, Bottom), // top-left bottom-left
                new Line(Left, Top, Right, Top), // top-left top-right
                new Line(Left, Bottom, Right, Bottom), // bottom-left bottom-right
                new Line(Right, Top, Right, Bottom), // top-right bottom-right
            ];
        ...
        public bool TryGetEdgeIntersections(Line line, out Vector2 firstIntersection, out Vector2 secondIntersection)
        {
            firstIntersection = default;
            secondIntersection = default;
            ...
            foreach (var edge in edges)
            {
                if (Line.TryGetIntersection(line, edge, out var intersection))
                {
        ...
        public bool TryGetFirstEdgeIntersection(Line line, out Vector2 intersection)
        {
